...
const ui = {
    ...
    adicionaMensagemSemPensamentos(){
        const listaPensamentos = document.getElementById("lista-pensamentos")
        const mensagem = document.createElement("img")
        mensagem.src = "assets/imagens/nada-por-aqui.png"

        listaPensamentos.appendChild(mensagem)
        console.log("heelo")
    },
